{{--
    ...
    judul, deskripsi, dan tombol CTA. Di-include per record oleh welcome.blade.
--}}
...
<section id="{{ $contentSection->anchor_id }}" class="py-20 sm:py-28"
         style="background:{{ $contentSection->background === 'alt' ? 'var(--bg-alt, var(--bg))' : 'var(--bg)' }}">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid gap-10 lg:gap-16 items-center {{ $hasImage ? 'lg:grid-cols-2' : 'max-w-3xl mx-auto text-center' }}">
            ...
            <div class="{{ $hasImage ? ($imageFirst ? 'lg:order-2' : 'lg:order-1') : '' }}"
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold tracking-tight mb-5" style="color:var(--text)">
